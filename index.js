...
*/
function getCarInfoByIndex(invCar, numInd) {
  return 'This is a ' + invCar[numInd].car_make + '' + invCar[numInd].car_model;
...
*/
function getLastCarInfo(invCar) {
  const lastCar  = [invCar.length - 1];
  return 'This is a ' + invCar[lastCar].car_make + ' ' + invCar[lastCar].car_model; 
}
...
*/
function sortCarInventory(invCar) {
  return invCar.sort((a,b) => (a.car_model > b.car_model) ? 1 : -1);
